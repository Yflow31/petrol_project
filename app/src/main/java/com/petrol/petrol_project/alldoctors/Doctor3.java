        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (auth.getCurrentUser() == null) {
                    Toast.makeText(Doctor3.this, "User not logged in", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                db.collection(FirebaseConstants.USER_COLLECTION.toString())
                        ...
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(Doctor3.this, "Appointment Booked Successfully", Toast.LENGTH_SHORT).show();
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(Doctor3.this, "Failed to book appointment: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
            }
        });
    }
